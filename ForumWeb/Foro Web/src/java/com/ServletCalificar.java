...
public class ServletCalificar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String autorComen = request.getParameter("autorcom");
        ...
        try {
            ...
            if(tema.calificarCom(titulo, autorComen, cal)){
            ...
            Logger.getLogger(ServletCalificar.class.getName()).log(Level.SEVERE, null, ex);
        } finally {            
            out.close();
        }
    }
